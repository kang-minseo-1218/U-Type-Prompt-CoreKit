...
- **Attribution** — You must give appropriate credit to `minseo_kang`, provide a link to the license, and indicate if changes were made.
...
（参考訳）  
この構造は、非商用利用に限り自由に使用できます。再配布や引用の際は、必ず `minseo_kang` を明記してください。  
Creative Commons BY-NC 4.0 ライセンスに基づきます。
